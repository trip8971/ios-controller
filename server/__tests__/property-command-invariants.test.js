 ...
 *
 * Property: For any valid tap Control_Command, the JSON must contain "type",
 * "x", "y" fields. For any valid swipe Control_Command, the JSON must contain
 * "type", "startX", "startY", "endX", "endY" fields, and when "duration" is
 * present it must be a positive number. Volume commands must only contain
 * the "type" field.
 */
